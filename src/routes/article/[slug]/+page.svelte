...
<div class="article-page">
    ...
    <div class="container page">
        ...
        <div class="article-actions">
            <div class="article-meta">
                <a href="profile.html"><img src="http://i.imgur.com/Qr71crq.jpg" alt="Eric Simons" /></a>
                <div class="info">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 offset-md-2">
                <form class="card comment-form">
                    ...
                    <img src="http://i.imgur.com/Qr71crq.jpg" alt="Jacob Schmidt" class="comment-author-img" />
